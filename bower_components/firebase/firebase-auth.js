...
(function () {
  ...
  var qb = null,
    ...
    if (!qb) {
      ...
      for (var a = 0; 65 > a; a++) qb[a] = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(a), rb[qb[a]] = a, 62 <= a && (rb["ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_.".charAt(a)] = a);
    }
  };
  ...
  var Cb = function (a) {
    ...
    for (var d = a.h[0] | 0, e = a.h[1] | 0, k = a.h[2] | 0, n = a.h[3] | 0, C = a.h[4] | 0, db = a.h[5] | 0, Pb = a.h[6] | 0, f = a.h[7] | 0, b = 0; 64 > b; b++) var Ah = ((d >>> 2 | d << 30) ^ (d >>> 13 | d << 19) ^ (d >>> 22 | d << 10)) + (d & e ^ d & k ^ e & k) | 0, g = C & db ^ ~C & Pb, f = f + ((C >>> 6 | C << 26) ^ (C >>> 11 | C << 21) ^ (C >>> 25 | C << 7)) | 0, g = g + (wb[b] | 0) | 0, g = f + (g + (c[b] | 0) | 0) | 0, f = Pb, Pb = db, db = C, C = n + g | 0, n = k, k = e, e = d, d = g + Ah | 0;
  ...
  var Sb = "closure_lm_" + (1E6 * Math.random() | 0),
    ...
    if (!Gb) {
      ...
      if (!(0 > d.keyCode || void 0 != d.returnValue)) {
        ...
        for (e = 0; !b.nb && e < d.length; e++) b.currentTarget = d[e], f = gc(d[e], a, !1, b), c = c && f;
      }
    ...
    if (null == b) c.push("null");else {
      if ("object" == typeof b) {
        ...
        if (b instanceof String || b instanceof Number || b instanceof Boolean) b = b.valueOf();else {
          ...
          for (d in b) Object.prototype.hasOwnProperty.call(b, d) && (e = b[d], "function" != typeof e && (c.push(f), yc(d, c), c.push(":"), vc(a, a.yc ? a.yc.call(b, d, e) : e, c), f = ","));
  ...
  var fd = new Jc(function () {
    ...
    return new A(function (b) {
      ...
      if (c) for (var e = function (a, e, f) {
        ...
        0 == c && b(d);
      }, f = 0, g; f < a.length; f++) g = a[f], id(g, ka(e, f, !0), ka(e, f, !1));else b(d);
    });
  };
  ...
  var Hd = function (a) {
    ...
    a.ra = b;
    d && (k = q(a.Hd, a, !0), d = q(a.Hd, a, !1), b instanceof vd ? (Fd(b, k, d), b.Cd = !0) : b.then(k, d));
  ...
  var Dd = function (a) {
    ...
    if (this && this.fe) {
      var a = this.fe;
      a && "SCRIPT" == a.tagName && Md(a, !0, this.Zb);
    }
  },
      Md = function (a, b, c) {
  ...
  var Ud = function (a) {
    ...
    if (!a.Z || "function" != typeof a.Z) {
      ...
      Wd = function (a, b) {
    if (a.forEach && "function" == typeof a.forEach) a.forEach(b, void 0);else if (fa(a) || m(a)) w(a, b, void 0);else for (var c = Vd(a), d = Ud(a), e = d.length, f = 0; f < e; f++) b.call(void 0, d[f], c && c[f], a);
  };
  ...
  F.prototype.send = function (a, b, c, d) {
    ...
    "withCredentials" in this.b && this.b.withCredentials !== this.te && (this.b.withCredentials = this.te);
  ...
  var Rf = function (a) {
    ...
    a = d.ea;
    d = d.ha;
    "chrome-extension" == d ? c = ma("This chrome extension ID (chrome-extension://%s) is not authorized to run this operation. Add it to the OAuth redirect domains list in the Firebase console -> Auth section -> Sign in method tab.", a) : "http" == d || "https" == d ? c = ma("This domain (%s) is not authorized to run this operation. Add it to the OAuth redirect domains list in the Firebase console -> Auth section -> Sign in method tab.", a) : b = "operation-not-supported-in-this-environment";
    O.call(this, b, c);
  };
  ...
  var Eg = function (a, b) {
    ...
    var k = "GET" == c;
    if (k) for (var n in d) d.hasOwnProperty(n) && J(g, n, d[n]);
    ...
    return Lg(a).then(function (a) {
      a: {
        for (var c = Pe(b), e = c.ha, c = c.ea, f = 0; f < a.length; f++) {
          ...
          g = c;
          var n = e;
          0 == k.indexOf("chrome-extension://") ? g = Pe(k).ea == g && "chrome-extension" == n : "http" != n && "https" != n ? g = !1 : ef.test(k) ? g = g == k : (k = k.split(".").join("\\."), g = new RegExp("^(.+\\." + k + "|" + k + ")$", "i").test(g));
  ...
  var T = function (a, b, c) {
    ...
    return gf() ? new li(a, b, c, d) : new th(a, b, c, d);
  };
  ...
  var pj = function (a, b, c, d, e) {
    ...
    d = d().then(function () {
      ...
      return new A(function (c, d) {
        a.Va(b, null, new O("cancelled-popup-request"), a.ca || null);
        a.aa = c;
        a.Pa = d;
        a.ca = g;
        a.F = a.m.Vb(a, b, n, g);
  ...
  var W = function (a) {
    ...
    this.pb = new zj(V(this).options.apiKey + ":" + V(this).name);
  ...
  var Mj = function (a, b) {
    ...
    var f = cf(e, c && c.Mb, c && c.Lb),
      ...
      return new A(function (b, c) {
        a.Va("signInViaPopup", null, new O("cancelled-popup-request"), a.ca);
        a.aa = b;
        a.Pa = c;
        a.ca = d;
  ...
  var Nj = function (a) {
    ...
    return a.cc.then(function () {
      ...
      Gj = function (a, b) {
    X(a) && (Yi(X(a), a.qe), dc(X(a), "tokenChanged", a.vb), dc(X(a), "userDeleted", a.oe), dc(X(a), "userInvalidated", a.pe), Xi(X(a)));
  ...
  ak(W.prototype, {
    ...
    onAuthStateChanged: {
      ...
      a: [Yj(Z(), Uj(), "nextOrObserver"), Uj("opt_error", !0), Uj("opt_completed", !0)]
    },
